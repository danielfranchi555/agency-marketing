...
const Footer = () => {
    return (
        <div className=' md:grid md:grid-cols-2 mt-[150px] '>
            <div className='flex flex-col justify-center gap-5 md:gap-5 '>
                <h6 className='text-[#fff] text-[30px] lg:text-[50px] md:max-w-[500px] font-semibold'>Creative Digital Marketing Agency</h6>
